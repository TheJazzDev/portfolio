...
const Image = ({imageRef, animate}) => {
  return (
    <div
      ...
      <div className="bg border-4 border-dashed rounded-2xl border-lightMode-100 w-52 h-52 lg:w-64 lg:h-64 will-change-transform absolute bottom-4 lg:bottom-12 opacity-0" />
      <img
        src={Taiwo}
